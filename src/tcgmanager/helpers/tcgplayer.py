...
class TCGPlayerBase():
    ...
    def getAuthCode(self):
        ...
        if path.exists("secrets/authcode"):
            ...
            now = datetime.now()
            expires = datetime.strptime(authcodeJSON[".expires"], "%a, %d %b %Y %H:%M:%S GMT")
            if now > expires:
    ...
    def authenticate(self):
        ...
        body = "grant_type=client_credentials&client_id={}&client_secret={}".format(public_key.strip(), private_key.strip())
